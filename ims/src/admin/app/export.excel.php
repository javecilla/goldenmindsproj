...
<head>
	...
	<title>GMCIS | Excel Report</title>
...
<body onload="export_excel_report()">
	
	<div class="card" style="width:100%; background: url('../resources/images/system-photo/gmc-bg.png');"> 
		<center>
      ...
      <table id="tblEquipment" class="table table-bordered table-responsive " style="width:100%">
        <thead>
          <tr>
	      ...
	      <tbody id="tbodyPrint">
	      	<?php
	      		...
	      		if(isset($_GET['gr']) && $_GET['gr'] == 'excel') {
	...
	<script type="text/javascript">
		function export_excel_report() {
			let tableData = document.getElementById('tblEquipment');
			let location = "<?php echo $locationRack; ?>";
			var fp = XLSX.utils.table_to_book(tableData, {
				sheet: 'equipment_name'
			});
			XLSX.write(fp, {
				bookType: 'xlsx',
				type: 'base64'
			});
			XLSX.writeFile(fp, 'INVENTORY-REPORT_' + location + '.xlsx');
		}
  </script>
</body>
</html>