								   ...
								   <div class="col-md-8">
									  ...
									  <!-- count total vote points for specific candidate -->
									   <?php
										...
										?>
										<small><b>Current Vote Points</b> :</small>
										...
										<small><b>Select Amount of Payment</b> :</small>
								      		...
								      		<center>
											<img src="resources/images/qrcode/qr_payment=20.jpg" class="img-fluid img-thumbnail" width="200" id="qrcode_img"/><br/><br/>
										</center>
										<hr>
	...
	<script type="text/javascript">
		...
		function amtPayment() {
			...
			if(selectedAmtPayment === '20') {
				...
				document.getElementById('qrcode_img').src = 'resources/images/qrcode/qr_payment=50.png';
				document.getElementById('votePoints').value = 60;
			}
			else if(selectedAmtPayment === '100') {
				document.getElementById('qrcode_img').src = 'resources/images/qrcode/qr_payment=100.png';
			...
			if(isEmpty(amtPayment)) {
				...
				$.ajax({
				   ...
				   error: function(error) { //if error
				   	alert(error);
				   	window.location.href = 'voting candidate information.php?cid=' + cid + '&category=' + prevBASE_URL;
				   }
				});
			}
		}
