...
<tr>
<th style = 'height: 100; border: 3px solid black;'>
...
<input type = 'submit' name = 'testsave' id = 'btnsave' style = 'height: 40; width: 110; text-align: center;  font-size: 25;' value = 'Save' onclick = 'calc()'>
...
$sql = mysqli_query($cn, "select * from subjects where teacher = '$txtusername' and strand = '$txtstrand' and semester = '$cmbsem' and yr_sec = '$cmbyear' order by subj_order asc;");
$grades = mysqli_num_rows($sql);

while($row = mysqli_fetch_assoc($sql))
{
$cmbsubjdesc = $row['subj_no'];

echo"<tr>

<td style = 'border: 3px solid black; border-top: none; min-width: 200; max-width: 200; height: 60; text-align: center; font-size: 25;'>

<input list = 'subjdesc' name = 'cmbsubjdesc' id = 'cmbsubjdesc' style = 'height: 40; width: 400; text-align: center; border-color: 28110d; border-radius: 5px; font-size: 25;' value = '$row[subj_desc]' readonly onclick = 'clrsubjdesc()'>
...
$sql = mysqli_query($cn, "select * from subjects where teacher = '$txtusername' and strand = '$cmbstrand' and semester = '$cmbsemester' and yr_sec = '$cmbyear' and subj_order = '01'");
$subj = mysqli_num_rows($sql);

while($row = mysqli_fetch_assoc($sql))
{
$sql = mysqli_query($cn, "insert into grades (username, lrn, learners_name, sy, semester, strand, yr_sec, subj_desc) values ('$txtuser', '$txtlrn', '$txtlearnersname', '$cmbsy', '$cmbsemester', '$cmbstrand', '$cmbyrsec', '$row[subj_desc]')");

$sql = mysqli_query($cn, "update grades set midterm = '$txtmidterm', finals = '$txtfinals', ave = '$txtave', remarks = '$txtremarks' where username = '$txtuser' and subj_desc = '$row[subj_desc]'");
}


//for ($x = 1; $x <= $subj; $x++)
//{
//$sql = mysqli_query($cn, "insert into grades (username, lrn, learners_name, sy, semester, strand, yr_sec, subj_desc) values ('$txtuser', '$txtlrn', //'$txtlearnersname', '$cmbsy', '$cmbsemester', '$cmbstrand', '$cmbyrsec', '$cmbsubjdesc')");
//}
